...
exports.CreatingTheProjectTable1754402477754 = void 0;
class CreatingTheProjectTable1754402477754 {
    name = 'CreatingTheProjectTable1754402477754';
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "projects" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "startDate" date, "endDate" date, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "created_by_user_id" integer NOT NULL, "company_id" integer, CONSTRAINT "PK_6271df0a7aed1d6c0691ce6ac50" PRIMARY KEY ("id"))`);
...
exports.CreatingTheProjectTable1754402477754 = CreatingTheProjectTable1754402477754;
//# sourceMappingURL=1754402477754-CreatingTheProjectTable.js.map