...
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_entity_1.Users, { nullable: false, onDelete: 'SET NULL' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_entity_1.Users, { nullable: true, onDelete: 'SET NULL' }),
    (0, typeorm_1.JoinColumn)({ name: 'assigned_to_user_id' }),
    __metadata("design:type", users_entity_1.Users)
], Projects.prototype, "assignedTo", void 0);
__decorate([
